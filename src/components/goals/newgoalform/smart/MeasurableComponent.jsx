...
const MeasurableComponent = ({ measurable, setMeasurable }) => {
  ...
  return (
    <div>
      ...
      <textarea id="measurableAccomplishment" value={measurable.accomplishment} onChange={(e) => handleChange('accomplishment', e.target.value)} className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 resize-none focus:border-black focus:ring-2 focus:ring-black focus:outline-none" rows="2" required></textarea>
